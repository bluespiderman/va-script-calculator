...
import vaScriptBase10Base2Base8 from './vaop/va-scripts/va-script_v1_base10_and_base2_and_base8.json';
...
function AppVal() {
  ...
  const [isBase10Base8, setIsBase10Base8] = useState(false);


  //const [vaScript, setVaScript] = useState(vaScriptBase10Base2Base8);
    ...
    if (vaScript.hasOwnProperty(nextAction)) {
      ...
      switch (nextAction) {
        ...
        case "Action_switch_to_base2and10":
          ...
          setOperandTwo('');
          setResult('')
          setVaScript(vaScriptBase10Base2Base8);
          setIsBase10Base2(true);
          setIsBase10Base8(false);
          setIsBase10(false);
          break;
        case "Action_switch_to_base8and10":
          setOperandOne('');
          setOperandTwo('');
          setResult('')
          setVaScript(vaScriptBase10Base2Base8);
          setIsBase10Base2(false);
          setIsBase10Base8(true);
          setIsBase10(false);
          break;
        case "Action_clear":
          setOperandOne('');
        ...
        case "Action_binary_show_result":
          ...
          break;
        case "Action_octal_show_result":
          console.log('asdf', operandOne, operandTwo);
          var temp_3 = parseInt(operandOne, 8) + parseInt(operandTwo, 8);
          setResult(temp_3.toString(8));
          break;
        case "Action_list_show_result":
          var temp_3;
          if (result) {
            temp_3 = +result + +operandTwo;
            console.log('if', result, 'operand t', operandTwo);
            setResult(temp_3);
          } else {
            temp_3 = +operandOne + +operandTwo;
            setResult(temp_3);
          }
          setOperandOne(temp_3);
          setOperandTwo('');
          break;
        ...
        case "Action_binary_operand_1_attach_one":
          setOperandOne(operandOne + '1')
          break;
        case "Action_octal_operand_1_attach_zero":
          setOperandOne(operandOne + '0')
          break;
        case "Action_octal_operand_1_attach_one":
          setOperandOne(operandOne + '1')
          break;
        case "Action_octal_operand_1_attach_two":
          setOperandOne(operandOne + '2')
          break;
        case "Action_octal_operand_1_attach_three":
          setOperandOne(operandOne + '3')
          break;
        case "Action_octal_operand_1_attach_four":
          setOperandOne(operandOne + '4')
          break;
        case "Action_octal_operand_1_attach_five":
          setOperandOne(operandOne + '5')
          break;
        case "Action_octal_operand_1_attach_six":
          setOperandOne(operandOne + '6')
          break;
        case "Action_octal_operand_1_attach_seven":
          setOperandOne(operandOne + '7')
          break;
        case "Action_octal_operand_2_attach_zero":
          setOperandTwo(operandTwo + '0')
          break;
        case "Action_octal_operand_2_attach_one":
          setOperandTwo(operandTwo + '1')
          break;
        case "Action_octal_operand_2_attach_two":
          setOperandTwo(operandTwo + '2')
          break;
        case "Action_octal_operand_2_attach_three":
          setOperandTwo(operandTwo + '3')
          break;
        case "Action_octal_operand_2_attach_four":
          setOperandTwo(operandTwo + '4')
          break;
        case "Action_octal_operand_2_attach_five":
          setOperandTwo(operandTwo + '5')
          break;
        case "Action_octal_operand_2_attach_six":
          setOperandTwo(operandTwo + '6')
          break;
        case "Action_octal_operand_2_attach_seven":
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        {isBase10Base8 &&
          <div>
            <h2>Mini Va-Calculator (Base 8 and Base 10)</h2>
            <h5>For binary operation start first operand with '0'</h5>
          </div>
        }
        {isBase10Base2 &&
        ...
        {isBase10 &&
          <div>
            ...
            <CalcButton onClick={() => getAction('Direction_switch_to_base8and10')} buttonName='Switch to base 8 & 10 ' />
          </div>
        }
        {showWarning &&
        ...
        <p>
          ...
          <CalcButton onClick={() => getAction('Direction_plus_equal')} buttonName='=+' /><br /><br />
        </p>
        <p>
